/**
 * @fileOverview Contains code related to the FMV FormValidator class
...
(function( $ ) {
    ...
    function FormValidator(formGroupElement, triggerElement, customRulesObject) {
        ...
        /** Set of validator rules. Default rules must be defined in FormValidatorConfig.js that loads before this class, on FMV.defaultValidatorRules
         ...
         * @type Object
         */
        var _validatorRules = FMV.defaultValidatorRules ? FMV.defaultValidatorRules : {};

        /** Object containing Localized strings, where each key is a locale code, and each value is a nested object containing the
         * individual string IDs and their localized translation. These values need to be defined in FormValidatorConfig.js as FMV.validatorStrings
         ...
         * @type object
         */
        var _strings = FMV.validatorLocalizedStrings ? FMV.validatorLocalizedStrings : {};

        /**
         * How long to wait for asynchronous validation callbacks before they timeout. Must be modified in FormValidatorConfig.js as FMV.validatorAsyncTimeoutDuration
         * @type number
         */
        var _asyncTimeoutDuration = FMV.validatorAsyncTimeoutDuration !== undefined ? FMV.validatorAsyncTimeoutDuration : 3000;
        ...
        if (FMV.validatorHTMLStrings) {
            $.each(_markupStrings, function(key, value){
                if (FMV.validatorHTMLStrings[key]) {
                    _markupStrings[key] = FMV.validatorHTMLStrings[key]
                }
            });
        }
        ...
        if (FMV.customLogicForElementToFollow && typeof FMV.customLogicForElementToFollow == "function") {
            _customLogicForElementToFollow = FMV.customLogicForElementToFollow;
    ...
    /**
     * Make class publically reachable. Create a new instance like this: var myValidator = new FMV.FormValidator(container);
     * NOTE: This global variable can be changed if necessary, it won't break the class
     *
     */
    FMV.FormValidator = FormValidator;
})( jQuery );
