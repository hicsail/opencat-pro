...
lab.experiment('User Class Methods', () => {
    ...
    lab.test('it returns a new instance when create succeeds', (done) => {
        ...
        User.create('ren@stimpy.show', 'bighouseblues', 'ren', '', 'stimpy', '2016-07-22T19:18:18.403Z', 'male', 12345, '', (err, result) => {
    ...
    lab.test('it returns a result when finding by login', (done) => {
        ...
        Async.auto({
            user: function (cb) {
                ...
                User.create('ren@stimpy.show', 'thebigshot', 'ren', '', 'stimpy', '2016-07-22T19:18:18.403Z', 'male', 12345, '', cb);
            },
	...
	//I might have changed something with this...
    ...
    lab.test('it returns a result when finding by username', (done) => {
        ...
        Async.auto({
            user: function (cb) {
                ...
                User.create('horse@man.show', 'eathay', 'horse', '', 'man', '2016-07-22T19:18:18.403Z', 'male', 12345, '', (err, result) => {
