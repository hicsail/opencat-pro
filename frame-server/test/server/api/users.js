...
lab.experiment('Users Plugin Create', () => {
    ...
    lab.beforeEach((done) => {
        ...
        request = {
            ...
            url: '/users',
            payload: {
                username: 'mrmud@mudmail.mud',
				password: 'dirtandwater',
                firstName: 'Muddy',
				middleName: '',
				lastName: 'Mudskipper',
				birthday: '2016-07-22T19:18:18.403Z',
				gender: 'male',
				siteNum: 12345,
				comments: ''
            },
    ...
    lab.test('it returns an error when create fails', (done) => {
        ...
        stub.User.create = function (username, password, firstName, middleName, lastName, birthday, gender, siteNum, comments, callback) {
...
lab.experiment('Users Plugin (My) Update', () => {
    ...
    lab.test('it updates a document successfully', (done) => {
        ...
        stub.User.findByIdAndUpdate = function () {
            ...
            callback(null, { _id: '1D', username: 'mrmud@mudmail.mud' });
        };
